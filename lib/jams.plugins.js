...
JAMSmidiNote.prototype.run = function(t, z, a) { 
	...
	if( a == 1 || a == 0 ) this.runningValues[a] = 0;
...
JAMSOnOffEnvelope.prototype.run = function (t, z, a) {
	...
	if (this.inputs[0].module.run(t, 0, this.inputs[0].index) == 1) this.output = 1; 
	if (this.inputs[1].module.run(t, 1, this.inputs[1].index) == 1) this.output = 0; 
	return this.output;
}
// ----
