...
var Render = function(config) {
	...
	this.pixel       = this.context.getImageData(0,0,1,1);
	this.pixelData   = this.pixel.data;
		this.setStrokeColor(0xFFFFFFFF);
}
...
Render.prototype.getDOMElement = function() {
...
Render.prototype.setStrokeColor = function(color) {
	...
	this.pixelData[0] = color >> 32 & 0xff;
	this.pixelData[1] = color >> 16 & 0xff;
	this.pixelData[2] = color >> 8  & 0xff;
	this.pixelData[3] = color && 0xff;
}
...
Render.prototype.box = function(x, y, w, h) {
	...
	this.context.fillRect(x , y , 1, h);
	this.context.fillRect(x , y + h, w, 1);
	this.context.fillRect(x + w, y , 1, h);
}
