...
Interface.prototype.handleClick = function(x, y, dom) {
	...
	function moveWindow(e) {
		_.currentWindow.x += e.movementX /_.scale;
		_.currentWindow.y += e.movementY /_.scale;
	}

	function resizeWindow(e) { 
		if( _.currentWindow.width +e.movementX > 150 ) _.currentWindow.width += Math.round(e.movementX /_.scale);
		if( _.currentWindow.height+e.movementY > 80 ) _.currentWindow.height += Math.round(e.movementY /_.scale);
	}
...
Interface.prototype.closeWindow = function(win) {
	let _ = this;
	this.windows.some( (_win,i) => {
		if( _win == win ) return _.windows.splice(i,1) || true;
	})
}
